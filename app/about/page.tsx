...
const timelineEvents = [
  {
    ...
    title: 'The Beginning',
    description:
      'ETIQU was established with a vision to create career opportunities through sales, marketing, and leadership development.',
  },
  {
    year: '2018',
    title: 'First Owner Promotion',
    description:
      "The organization achieved its first Owner Promotion, marking an important milestone in ETIQU's leadership and growth journey.",
  },
  {
    year: '2020',
    title: 'Telecalling Division Launched',
    description:
      'Following the pandemic, ETIQU expanded its operations by launching the Telecalling Division, adapting to new business opportunities and market demands.',
  },
  {
    year: '2024',
    title: 'First Telecalling Assistant Owner Promotion',
    description:
      "The Telecalling Division achieved its first Assistant Owner Promotion, reflecting the success of ETIQU's training and leadership development system.",
  },
  {
    year: '2025',
    title: 'Field Assistant Owner Promotion',
    description:
      "ETIQU continued its growth momentum by achieving an Assistant Owner Promotion through the Field Division, strengthening the organization's expansion and leadership culture.",
  },
  {
    year: '2026',
    title: 'Two Owner Promotions Achieved',
    description:
      "A major milestone was reached in 2026 with two successful Owner Promotions achieved within the same year through the Field Division, reinforcing ETIQU's commitment to building future entrepreneurs and leaders.",
  },
];
            ...
            <div className="px-8 py-16 lg:px-16 lg:py-20">
              ...
              <FadeIn delay={0.1}>
                <h2 className="font-playfair text-3xl md:text-4xl font-semibold text-[var(--navy)] leading-tight mb-6">
                  About Mr. Saravana Kumar, Managing Director of ETIQU
                </h2>
              </FadeIn>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-12 justify-items-center">
            {team.map((member, i) => (
              <FadeIn key={member.name} delay={i * 0.15}>
                <div className="group text-center max-w-[320px] w-full flex flex-col items-center">
                  ...
                  <div className="min-h-[70px] flex flex-col justify-center">
                    <h3 className="font-playfair text-lg font-semibold text-[var(--navy)]">
                      {member.name}
                    </h3>
